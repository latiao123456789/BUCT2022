...
class MuseumSpider(scrapy.Spider):
    ...
    start_urls = ['https://collections.rom.on.ca/search/Chinese#filters']
    base_url = 'https://collections.rom.on.ca/search/Chinese/objects/images?page=%d'
    # https: // collections.rom.on.ca / search / Chinese / objects / images?page = 1
    # https: // collections.rom.on.ca / search / Chinese / objects / images?page = 2
    # https: // collections.rom.on.ca / search / Chinese / objects / images?page = 3
    # 观察可得对于安大略皇家博物馆的爬取
